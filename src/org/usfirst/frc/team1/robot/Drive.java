...
public class Drive {
	...
	boolean onRotationTarget() {
		if (driveRotation_pidController.onTarget()) {
			return true;
		} else {
			return false;
		}
	...
	void RotationTolerance(double percentage) {
		driveRotation_pidController.setPercentTolerance(percentage);
	}
	...
	boolean onSpeedTarget() {
		if (driveSpeed_pidController.onTarget()) {
			return true;
		} else {
			return false;
		}
	...
	void SpeedTolerance(double percentage) {
		driveSpeed_pidController.setPercentTolerance(percentage);
	}
